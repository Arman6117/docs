...
export const Ruler = () => {
  ...
  const handleMouseMove = (e: React.MouseEvent) => {
    if ((isDraggingRight || isDraggingLeft) && rulerRef.current) {
  ...
  return (
    <div
      className="h-6 w-full border-b border-gray-300 flex items-end relative select-none print:hidden "
      ref={rulerRef}
                ...
                >
                  {marker % 10 === 0 && (
                    <>
                      ...
                      <span className="text-[10px] text-neutral-500 transform -translate-x-1/2 absolute bottom-2">
                        {marker / 10}
                      </span>
                    </>
                  )}
...
const Marker = ({
  ...
  return (
    ...
    >
      <FaCaretDown className=" absolute left-1/2 top-0 h-full transform -translate-x-1/2 fill-blue-500" />
      <div
